...
export class SubjectsImageTestsMiningPage implements OnInit, OnDestroy {
  ...
  public columnDefs: (ColDef | ColGroupDef)[] = [
    { headerName: 'Información de la prueba',
      children: [
    ...
    { headerName: 'Paciente',
      children: [
        ...
        { field: 'genre', headerName: 'Género', filter: 'agSetColumnFilter', filterParams: this.filterParamsGR },
  ...
  async getSubjectsImageTest(pageSize: number, currentPage: number, params: any ): Promise<void> {
    ...
    console.log(this.subjectsImageTest.length, "TAMAÑO DE LOS SUJETOS");
    /*
